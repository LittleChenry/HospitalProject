                         ...
                         <div class="row" style="height:500px">
                                    ...
                                    <div id="recordbase" style="position:relative;display:none;top:50px">
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                         <th><label for="fixEquip" class="height">固定装置</label></th>
                                          <td>
                                           <select id="fixEquip" name="fixEquip" class="form-control">                
                                           </select>
                                         </td>
                                     </tr>
                                         <tr>
                                         <th><label for="bodyPost" class="height">体位</label></th>
                                          <td>
                                              
                                           <select id="bodyPost"  name="bodyPost"   class="form-control"> 

                    ...
                    <ul class="nav in" id="side-menu" style="margin-top:0px;">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level collapse">
                                <li>
                                    <a href="Ys-CheckTreatment.aspx" title="no"><i class="fa  fa-eye   fa-fw"></i><span>疗程查询</span></a>
                                </li>
                                <li>
                                    <a href="Ys-RequireTreatment.aspx" title="no"><i class="fa   fa-cloud-upload    fa-fw"></i><span>疗程申请</span></a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                           <li>
                            ...
                            <ul class="nav nav-second-level collapse">
                                <li>
                            <a href="Diagnose.aspx" title="no"><span>诊断病情</span></a>
                        </li>
                        <li>
                            <a href="FixApply.aspx" title="no"> <span>体位固定申请</span></a>
                        </li>
                        <li>
                            <a href="LocationApply.aspx" title="no"> <span>模拟定位申请</span></a>
                        </li>
                        <li>
                            <a href="DiagnosePlanApply.aspx" title="no"><span>治疗计划申请</span></a>
                        </li>
                         <li>
                            <a href="ReplacementApply.aspx" title="no"><span>复位申请</span></a>
                        </li>
                          <li>
                            <a href="PDFConfirm.aspx" title="no"><span>PDF文件确认</span></a>
                        </li>
                      
                         <li>
                            <a href="TreatPlanConfirm.aspx" title="no"><span>治疗计划确认</span></a>
                        </li>   
                         <li>
                            <a href="FollowUpRecord.aspx" title="no"><span>总结随访</span></a>
                        </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>

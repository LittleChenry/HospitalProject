<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ys-RequireTreatment.aspx.cs" Inherits="YS_Ys_RequireTreatment" %>
...
<meta charset="utf-8"/>
    ...
    <link href="../CSS/YSrequireTreatment.css" rel="stylesheet" type="text/css" />

    <script src="../Scripts/YSrequireTreatment.js" type="text/javascript"></script>
</head>
<body>
    <input id="type" type="hidden" value="YS" />
    <div style="min-height:556px;">
        <h1 class="page-header title">疗程申请</h1>
          <div class="row">
